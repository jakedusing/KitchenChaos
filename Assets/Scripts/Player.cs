...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private void Awake() {
        if (Instance != null) {
            Debug.LogError("There is more than one player isntance");
        }
        Instance = this;    
    }
    ...
    private void HandleMovement() {
        ...
        if (!canMove) {
            ...
            canMove = (moveDir.x < - 5 || moveDir.x > + .5f) && !Physics.CapsuleCast(transform.position, 
            ...
            if (canMove) {
                ...
                canMove = (moveDir.z < - 5 || moveDir.z > + .5f) && !Physics.CapsuleCast(transform.position, 
